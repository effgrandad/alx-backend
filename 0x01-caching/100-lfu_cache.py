...
"""
This module shows how to perform simple caching in Python.
This time, we'll use FIFO caching.
If the cache is full, we shall discard
the first item and add a new one (FIFO).
"""
